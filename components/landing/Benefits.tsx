  ...
  return (
    <>
      <div className="flex items-start mt-8 space-x-3">
        ...
        {/* </div> */}
        <div>
          <h4 className="text-xl font-medium text-white-600 dark:text-gray-200">{props.title}</h4>
          <p className="mt-1 font-semibold text-zinc-800 dark:text-gray-400">{props.children}</p>
        </div>
      </div>
    </>
  );
