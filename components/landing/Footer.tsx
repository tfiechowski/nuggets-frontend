    ...
    <div className="relative">
      <Container>
          ...
          <div className="lg:col-span-2">
            <div>
              ...
              <Link href="/" legacyBehavior>
                <a className="flex items-center space-x-2 text-2xl font-medium text-zinc-900 dark:text-gray-100">
                  <span>
                    <Image
                      src={logoImage}
                      width="32"
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Nuggets is supercharging your sales team productivity.
            </div>
          </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()}. Made with ♥ by Nuggets
        </div>
      </Container>
    </div>
  );
